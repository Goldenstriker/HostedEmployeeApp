...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _employee_employee_component__WEBPACK_IMPORTED_MODULE_5__["EmployeeComponent"], _post_post_component__WEBPACK_IMPORTED_MODULE_7__["PostComponent"]],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]],
            providers: [_post_service__WEBPACK_IMPORTED_MODULE_6__["PostService"], _employee_service__WEBPACK_IMPORTED_MODULE_8__["EmployeeService"]]
        })
    ], AppModule);
    return AppModule;
}());
...
var EmployeeService = /** @class */ (function () {
    function EmployeeService(httpClient) {
        ...
        this.baseUrl = "https://my-json-server.typicode.com/Goldenstriker/employeedb";
    }
    EmployeeService.prototype.get_employees = function () {
        return this.httpClient.get(this.baseUrl + '/employees');
    };
    EmployeeService.prototype.get_employee = function (id) {
        return this.httpClient.get(this.baseUrl + '/employees/' + id);
    };
    EmployeeService.prototype.delete_employee = function (id) {
...
module.exports = "<table class=\"table table-striped\">\r\n<thead>\r\n  <tr>\r\n    <th>ID</th>\r\n    <th>Name</th>\r\n    <th>Action</th>\r\n  </tr>\r\n</thead>\r\n<tbody>\r\n  <tr *ngFor=\"let emp of employees\">\r\n<td [class.danger]=\"emp.id==103\">{{emp.id}}</td>\r\n<td>{{emp.first_name}}</td>\r\n<td><input type=\"button\" (click)=\"delete(emp)\" value=\"Delete\"/></td>\r\n</tr>\r\n</tbody>\r\n</table>"
...
var EmployeeComponent = /** @class */ (function () {
    ...
    EmployeeComponent.prototype.delete = function (emp) {
        var _this = this;
        //this.employees.splice(this.employees.indexOf(emp), 1);
        this.employeeService.delete_employee(emp.id).subscribe(function (res) {
            var index = _this.employees.indexOf(emp);
    ...
    EmployeeComponent.prototype.getEmployees = function () {
        var _this = this;
        this.employeeService.get_employees().subscribe(function (res) { return _this.employees = res; });
    };
...
var PostService = /** @class */ (function () {
    function PostService(httpClient) {
        ...
        this.baseUrl = "https://dataprovider.goldenstriker.repl.co/GetData/";
    }
    PostService.prototype.get_posts = function () {
...
module.exports = ".carousel-inner .carousel-item{\r\n\r\n  width:100%;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<!--<div id=\"demo\" class=\"carousel slide\" data-ride=\"carousel\">\n\n\n  <ul class=\"carousel-indicators\">\n    <li data-target=\"#demo\" *ngFor=\"let post of posts; let i =index\" [attr.data-slide-to]=\"i\" [class.active]=\"i==0\"></li>\n  </ul>\n  \n \n  <div class=\"carousel-inner\">\n    <div class=\"carousel-item active\" *ngFor=\"let post of posts; let i=index\" [class.active]=\"i==0\">\n     <!--<div class=\"card\">\n        <div class=\"card-header\">{{post.title}}</div>\n        <div class=\"card-body\">{{post.body}}</div> \n        <div class=\"card-footer\">{{post.id}}</div>\n      </div>\n      {{post.id}}\n    </div>\n  </div>\n  <a class=\"carousel-control-prev\" href=\"#demo\" data-slide=\"prev\">\n    <span class=\"carousel-control-prev-icon\"></span>\n  </a>\n  <a class=\"carousel-control-next\" href=\"#demo\" data-slide=\"next\">\n    <span class=\"carousel-control-next-icon\"></span>\n  </a>\n</div> -->\n<ul class=\"list-group\">\n  <li *ngFor=\"let post of posts; let i=index\" class=\"list-group-item\">{{post.id +\" \"+ post.title}}\n  </li>\n</ul>\n\n      "
...
var PostComponent = /** @class */ (function () {
    ...
    PostComponent.prototype.getPosts = function () {
        var _this = this;
        this.postService.get_posts().subscribe(function (res) { return _this.posts = res; });
    };
...
module.exports = __webpack_require__(/*! E:\EMPAPP\src\main.ts */"./src/main.ts");
